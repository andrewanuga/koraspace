...
export const enUS: TranslationDictionary = {
  ...
  pricing: {
    ...
    creatorProName: "Creator Pro",
    creatorProDesc: "For active creators & influencers",
    marketerProName: "Marketer Pro",
    marketerProDesc: "For growth operators & businesses",
    agencyName: "Agency / Teams",
    agencyDesc: "For agencies managing multiple brands",
