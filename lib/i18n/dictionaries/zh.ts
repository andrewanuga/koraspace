...
export const zh: TranslationDictionary = {
  ...
  pricing: {
    ...
    starterName: "新手免费版",
    starterDesc: "适合刚起步的独立创作者",
    creatorProName: "创作者专业版",
    creatorProDesc: "适合活跃创作者与个人品牌",
    marketerProName: "营销专家版",
    marketerProDesc: "适合出海品牌与成长型团队",
    agencyName: "代理商/多团队版",
    agencyDesc: "适合管理多个品牌的营销机构",
