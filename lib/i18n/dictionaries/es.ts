...
export const es: TranslationDictionary = {
  ...
  pricing: {
    ...
    starterDesc: "Para creadores individuales que comienzan",
    creatorProName: "Creator Pro",
    creatorProDesc: "Para creadores activos e influencers",
    marketerProName: "Marketer Pro",
    marketerProDesc: "Para operadores de crecimiento y empresas",
    agencyName: "Agencia / Equipos",
    agencyDesc: "Para agencias que gestionan múltiples marcas",
    ...
    plans: [
      {
        planKey: "starter",
        name: "Starter / Gratis",
        desc: "Para creadores individuales que comienzan",
        posts: "15 publicaciones programadas / mes",
        features: [
          "50.000 tokens de IA / mes",
          "3 cuentas sociales conectadas",
          "Calendario visual de contenido",
          "Compositor básico con IA",
      ...
      },
      {
        planKey: "creator",
        name: "Creator Pro",
        desc: "Para creadores activos e influencers",
        posts: "150 publicaciones programadas / mes",
        features: [
          "400.000 tokens de IA / mes",
          "6 cuentas sociales conectadas",
          "Tubería completa de composición IA",
          "Reutilizador de contenido (1 a 6)",
          "Radar de tendencias y Cerebro de Marca",
          "Puntuación y predicción de interacción",
        ],
        cta: "Probar Creator Pro",
        highlight: true,
        badge: "Favorito de Creadores",
      },
      {
        planKey: "marketer",
        name: "Marketer Pro",
        desc: "Para operadores de crecimiento y empresas",
        posts: "500 publicaciones programadas / mes",
        features: [
          "1.000.000 tokens de IA / mes",
          "10 cuentas sociales conectadas",
          "Agente Operador de Marketing",
          "CRM Social y clasificación de leads",
          "Campañas y automatizaciones multicanal",
          "Atribución completa de ingresos",
          "Soporte prioritario por WhatsApp y email",
        ],
        cta: "Probar Marketer Pro",
        highlight: false,
        badge: "Nivel Marketing",
      },
      {
        planKey: "agency",
        name: "Agencia / Equipos",
        desc: "Para agencias que gestionan múltiples marcas",
        posts: "Publicaciones programadas ilimitadas",
        features: [
          "3.000.000 tokens de IA / mes",
          "Integraciones sociales ilimitadas",
          "Portales de cliente ilimitados",
          "Enlaces de aprobación en 1 clic",
          "Permisos por roles y seguridad RLS",
          "Reportes de rendimiento en marca blanca",
          "Gestor de cuenta dedicado",
        ],
        cta: "Obtener Plan Agencia",
        highlight: false,
        badge: "Nivel Agencia",
      },
    ],
