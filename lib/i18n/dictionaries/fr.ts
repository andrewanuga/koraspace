...
export const fr: TranslationDictionary = {
  ...
  pricing: {
    ...
    starterName: "Starter / Gratuit",
    starterDesc: "Pour les créateurs solo qui se lancent",
    creatorProName: "Creator Pro",
    creatorProDesc: "Pour les créateurs actifs et influenceurs",
    marketerProName: "Marketer Pro",
    marketerProDesc: "Pour les responsables de croissance et PME",
    agencyName: "Agence / Équipes",
    agencyDesc: "Pour les agences gérant plusieurs marques",
    ...
    plans: [
      {
        ...
        desc: "Pour les créateurs solo qui se lancent",
        posts: "15 publications planifiées / mois",
        features: [
          "50 000 jetons IA / mois",
          "3 comptes sociaux connectés",
          "Calendrier visuel de contenu",
          "Rédacteur IA de base",
      ...
      },
      {
        planKey: "creator",
        name: "Creator Pro",
        desc: "Pour les créateurs actifs et influenceurs",
        posts: "150 publications planifiées / mois",
        features: [
          "400 000 jetons IA / mois",
          "6 comptes sociaux connectés",
          "Pipeline de rédaction IA complet",
          "Recycleur de contenu (1 vers 6 formats)",
          "Radar de tendances et Cerveau de Marque",
          "Notation de brouillon et prédiction d'engagement",
        ],
        cta: "Essayer Creator Pro",
        highlight: true,
        badge: "Choix Préféré des Créateurs",
      },
      {
        planKey: "marketer",
        name: "Marketer Pro",
        desc: "Pour les responsables de croissance et PME",
        posts: "500 publications planifiées / mois",
        features: [
          "1 000 000 jetons IA / mois",
          "10 comptes sociaux connectés",
          "Agent Opérateur Marketing dédié",
          "CRM Social et qualification de leads",
          "Campagnes et workflows multi-canaux",
          "Attribution complète des revenus",
          "Support prioritaire par WhatsApp et email",
        ],
        cta: "Essayer Marketer Pro",
        highlight: false,
        badge: "Formule Marketing",
      },
      {
        planKey: "agency",
        name: "Agence / Équipes",
        desc: "Pour les agences gérant plusieurs marques",
        posts: "Publications planifiées illimitées",
        features: [
          "3 000 000 jetons IA / mois",
          "Connexions de comptes illimitées",
          "Portails d'espaces clients illimités",
          "Liens d'approbation directe en 1 clic",
          "Permissions d'équipe et sécurité RLS",
          "Rapports de performance en marque blanche",
          "Responsable de compte dédié",
        ],
        cta: "Choisir le Forfait Agence",
        highlight: false,
        badge: "Formule Agence",
      },
    ],
  },
  faq: {
