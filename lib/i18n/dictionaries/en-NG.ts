...
export const enNG: TranslationDictionary = {
  onboarding: {
  ...
  megaMenus: {
    ...
    productLede: "Everything working together to scale your brand and revenue.",
    productCta: "Explore the KoraSpace platform",
    audienceEyebrow: "MADE FOR",
    audienceLede: "Built around how top Nigerian businesses and creators work.",
    audienceCta: "See how KoraSpace fits your business",
    integrationsEyebrow: "INTEGRATIONS",
    integrationsLede: "Connect the tools and social channels you use daily.",
    ...
    audiences: [
      {
        ...
        desc: "Build an active audience without hiring a bulky marketing team.",
      },
      {
        label: "Creators & influencers",
        desc: "Create, schedule, and grow your signature personal brand.",
      },
      {
        label: "Businesses & SMEs",
        desc: "Turn social attention into predictable customer sales in Naira.",
      },
      {
        label: "Agencies",
        desc: "Manage multiple client brands from a single unified portal.",
      },
      {
        label: "Marketing teams",
        desc: "Plan, review, approve and execute campaigns together.",
      },
      {
        label: "Online stores & e-commerce",
        desc: "Turn comments and DMs into paying customers effortlessly.",
      },
    ],
    resourceGroups: [
      {
  ...
  hero: {
    badge: "Autonomous AI Marketing Agent for Nigerian & Global Brands",
    ...
    statCreators: "5,000+ creators & Nigerian businesses",
  ...
  stories: {
    ...
    subtitle: "See how businesses across Nigeria scale their social presence and revenue with KoraSpace.",
    list: [
      {
        name: "Adaeze Okonkwo",
  ...
  pricing: {
    eyebrow: "Transparent Pricing in Naira (NGN)",
    titleLead: "Simple plans.",
    titleHighlight: "Predictable value.",
    subtitle:
      "Billed transparently in Nigerian Naira (NGN). Upgrade, downgrade, or cancel anytime. Every paid plan includes a 14-day free trial.",
  ...
  faq: {
    ...
    q6: "What payment methods are supported in Nigeria?",
  ...
  footer: {
    ...
    builtLocation: "Engineered in Lagos, Nigeria",
    links: {
      product: [
