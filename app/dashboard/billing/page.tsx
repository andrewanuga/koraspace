        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <div className="flex items-center gap-2"><AlertCircle className="h-3.5 w-3.5 text-[var(--fg-4)]" />
              <p className="text-[13px] text-[var(--fg-3)]">
                <strong>Paystack / OPay</strong> for Nigerian users. <strong>Stripe</strong> for international cards. <strong>Crypto (BTC, ETH, SOL via NOWPayments)</strong> for global users. Securely handled at checkout.
              </p>
            </div>
          </div>
          <div className="shrink-0">
            ...
            >
              ...
              <option value="crypto">Crypto — BTC / ETH / SOL (NOWPayments)</option>
            </select>
          </div>
        </div>
      </GlassCard>
