...
export const metadata: Metadata = {
  ...
  description: "How Koraspace collects, uses, and protects your data.",
};
...
export default function PrivacyPage() {
  return (
    <LegalShell
      ...
      intro="Koraspace helps you manage your social media accounts. This policy explains, in plain language, what we collect, why, and the control you have. We only ever access what you explicitly connect, and we never sell your data."
      other={{ href: "/terms", label: "Terms of Service" }}
    >
      <Section title="Who we are">
        <p>Koraspace (“Socially”, “we”, “us”) provides an AI-powered workspace for scheduling, publishing, engaging, and analyzing social media across connected platforms. This policy covers our website, app, and services.</p>
      </Section>
      ...
      <Section title="Children">
        <p>Koraspace is not intended for anyone under 16. We do not knowingly collect data from children.</p>
      </Section>
