...
[![Automated Tests](https://img.shields.io/badge/Tests-140%20Passing-success?style=for-the-badge&logo=vitest)](https://vitest.dev)
...
[Features](#-core-capabilities) • [Architecture](#-platform-architecture) • [Golden Journeys](#-product-level-golden-journeys) • [Test Pyramid](#-automated-test-pyramid-140-tests) • [Security & RBAC](#-security--multi-tenant-isolation) • [Quickstart](#-quickstart--deployment) • [API Reference](#-api-endpoints)
