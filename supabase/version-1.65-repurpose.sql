...
-- Phases 1-4: Projects, Outputs, AI Analysis, Transcripts & RLS
-- ============================================================================
...
-- 2. Repurpose Outputs Table (Each generated platform format)
...
drop policy if exists "Users can view their repurpose projects" on public.repurpose_projects;
create policy "Users can view their repurpose projects"
  on public.repurpose_projects for select
  using (auth.uid() = user_id);

drop policy if exists "Users can create repurpose projects" on public.repurpose_projects;
create policy "Users can create repurpose projects"
  on public.repurpose_projects for insert
  with check (auth.uid() = user_id);

drop policy if exists "Users can update their repurpose projects" on public.repurpose_projects;
create policy "Users can update their repurpose projects"
  on public.repurpose_projects for update
  using (auth.uid() = user_id);

drop policy if exists "Users can delete their repurpose projects" on public.repurpose_projects;
create policy "Users can delete their repurpose projects"
  on public.repurpose_projects for delete
  using (auth.uid() = user_id);

-- Outputs RLS Policies
drop policy if exists "Users can view their repurpose outputs" on public.repurpose_outputs;
create policy "Users can view their repurpose outputs"
  on public.repurpose_outputs for select
  using (auth.uid() = user_id);

drop policy if exists "Users can create repurpose outputs" on public.repurpose_outputs;
create policy "Users can create repurpose outputs"
  on public.repurpose_outputs for insert
  with check (auth.uid() = user_id);

drop policy if exists "Users can update their repurpose outputs" on public.repurpose_outputs;
create policy "Users can update their repurpose outputs"
  on public.repurpose_outputs for update
  using (auth.uid() = user_id);

drop policy if exists "Users can delete their repurpose outputs" on public.repurpose_outputs;
